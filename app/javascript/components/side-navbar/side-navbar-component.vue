<template>
  <div class="flex flex-col items-start pt-0 pl-0 pr-0 pb-8 absolute w-64 h-screen left-0 top-16 bg-gray-800">
     <a href="/ingredients">
     <item @click="changeActiveElement" label="Ingredientes" :active="activeElement==='Ingredientes'">
     ...
     <a href="/test">
     <item @click="changeActiveElement" label="Recetas" :active="activeElement==='Recetas'">
     <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-white" viewBox="0 0 20 20" fill="currentColor">
     ...
     <item  @click="changeActiveElement" label="Menús" :active="activeElement==='Menús'">
     <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-white" viewBox="0 0 20 20" fill="currentColor">
