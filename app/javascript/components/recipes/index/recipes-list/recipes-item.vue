<template>
  <div class="flex flex-row">
    <div class="flex flex-row w-10/12 justify-between items-center p-6 static h-24 bg-white border-2 border-solid border-gray-400 box-border my-2 flex-none flex-grow-0 self-stretch">
      <recipes-item-info
    ...
    <div class="flex flex-col justify-center items-center w-full">
      <a
        class=" flex justify-center items-center cursor-pointer h-12 mb-2 underline text-xl focus:outline-none"
