    ...
    <div class="flex flex-col">
      ...
      <div class="flex flex-col p-10 w-full bg-gray-50 my-10">
        ...
        <div class="flex flex-col lg:flex-row pb-4">
          <div class="flex items-center py-2 pr-2 lg:w-1/3">
            <div class="relative text-yellow-700 w-full">
              ...
              <input
                class="w-full py-2 pl-12 bg-gray-50 border-2 border-gray-600 rounded self-stretch focus:outline-none"
          ...
          <div class="flex justify-start p-2 my-auto">
            <base-button
